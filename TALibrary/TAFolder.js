...
class TAFolder{
    ...
    function GetQuestionId(questionType){
        ...
        //option to have a question outside of the TA folder
        //if(questionType == 'voeTemplate') {
            //var selectedQuestion = ParamUtil.GetSelectedOptions(_globals, 'p_ImpactAnalysisDimension')[0];
            //log.LogDebug('Selected question ' + JSON.stringify(selectedQuestion));
            //return selectedQuestion.Code;
        //}
