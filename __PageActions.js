class PageActions {
  ...
  */
    ...
    static function ActionBtn_Render(context) {
        ...
        var link = '<a href="'+ actionLink + '?U=' + userid + '&hier=' + hier==null?"":hier + '&pid=' + pid + '&pname=' + pname +  '&isResponsibleVisible=' + isResponsibleVisible +
            '&wave=' + wave +'&dimensionId='+ dimensionId==null?"":dimensionId +'&dimension=' + dimensionText==null?"":dimensionText + '&questionId=' + 
			statement==null?"":statement +'&questionText=' + statementText==null?"":statementText + '&currency=' + currency +
