...
class SuppressUtil {
    ...
    static
    function setTableSuppress(table, suppressSettings) {
        ...
        if (displayCellOption == 'hide') { table.SuppressData.CellDisplay = BaseDisplayOption.Hide;
            table.SuppressData.CellLimit = cellValue; } else if (displayCellOption == 'showMarker') { table.SuppressData.CellDisplay = BaseDisplayOption.ShowMarker;
            table.SuppressData.CellLimit = cellValue; } else table.SuppressData.CellDisplay = BaseDisplayOption.Show;
    }

    static
    function buildHierarchyTable(context) {
    ...
    static
    function buildHierarchyTableForResults(context) {
    ...
    static
    function buildReportBaseTable(context) {
    ...
    static
    function buildReportBaseNoFiltersTable(context) {
     ...
     */
    static
    function getReportBaseValue(context) {
        var report = context.report;
        var log = context.log;
     ...
     */
    static
    function reportBaseIsLowForFilters(context) {
    ...
    static
    function reportBaseIsLow(context) {
    ...
    static
    function hierarchyUnitIsSensitive(context) {
    ...
    static
    function isGloballyHidden(context) {
    ...
    static
    function isInitialReportBaseLow(context) {
     ...
     */
    static
    function buildReportBaseTableForHitlist(context, openTextQIds, tagQIds) {
