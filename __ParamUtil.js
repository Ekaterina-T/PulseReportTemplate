  ...
  */
    ...
    */
    ...
    static function selectedPulseSurveysHaveChanged(context) {
        ...
        log.LogDebug('oldPids='+JSON.stringify(oldPids));
        log.LogDebug('newPids='+JSON.stringify(newPids));

        if(oldPids) {
            log.LogDebug('surveys changed: '+!ArrayUtil.ifArraysIdentical(oldPids, newPids));
