class PageUtil {
    ...
    static function Initialise(context) {
        ...
        log.LogDebug(page.CurrentPageId+': 1')
        ...
        log.LogDebug(page.CurrentPageId+': 2')

        ParamUtil.Initialise(context); // initialise parameters
        log.LogDebug(page.CurrentPageId+': 3')
        ...
        log.LogDebug(page.CurrentPageId+': 4')
        ...
        log.LogDebug(page.CurrentPageId+': 5')
        ...
        log.LogDebug(page.CurrentPageId+': 6')
