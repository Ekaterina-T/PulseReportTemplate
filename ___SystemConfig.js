public class SystemConfig {
  ...
  */
    static var reportParameterValuesMap = {
        ...
        'p_Results_BreakBy':      { type: 'QuestionList', locationType: 'Page', page: 'Page_Results',              propertyName: 'BreakVariables', isQuestionBased: true, CachingDisabled: true},
        'p_OrgOverviewBreakBy':   { type: 'QuestionList', locationType: 'Page', page: 'Page_KPI',                  propertyName: 'OrgOverviewBreakVariables', isQuestionBased: true, CachingDisabled: true},
        ...
        'p_Demographics':         { type: 'QuestionList', locationType: 'Page', page: 'Page_Response_Rate',        propertyName: 'DemographicsQuestions', isQuestionBased: true, CachingDisabled: true},
